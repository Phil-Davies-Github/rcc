...
urlpatterns = [
    ...
    path('intermediate/<int:object2_id>/update/', views.EventRaceResultsUpdateView.as_view(), name='update_intermediate'),   
    ...
    #Test Patterns
    path('event_race/<int:race_id>/update/', views.EventRaceResultsUpdateView.as_view(), name='update_event_race_results'),  
]